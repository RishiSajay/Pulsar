...
public class Player3 : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        transform.rotation = Quaternion.Euler(0f, 0f, rotateAmount - 90.0f);
        ...
        Vector2 direction = (Vector2)mousePosWorld - (Vector2)transform.position;
        direction.Normalize();
